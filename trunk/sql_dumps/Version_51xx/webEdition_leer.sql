...
DROP TABLE IF EXISTS `tblcustomerfilter`;
...
--
-- Table structure for table `tblvotinglog`;
-- 
...
--
-- Data for table `tblwidgetnotepad`
--
...
--
-- Table structure for table `tblMetadata`
--
