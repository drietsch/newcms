...
CREATE TABLE tblPrefs (
  ...
  cockpit_amount_last_documents int(2) NOT NULL default '0',
  cockpit_rss_feed_url text NOT NULL,
...
INSERT INTO tblPrefs VALUES (1,0,'1','1,10',0,'.html','.php','.html',0,0,0,0,0,0,'Deutsch','','',0,98,1,900,700,0,0,'none',-1,0,20,0,0,0,0,'','',5,'',1);
...
INSERT INTO tblWebUser VALUES (1,'admin','admin',0,'','','webEdition1','Software GmbH','Waldstrasse 40b','76133 Karlsruhe','Baden-Württemberg','Deutschland','','','','','','0','1144395493','1144397956',0,'/admin',0,'customer.gif','admin','','','Administratoren');
INSERT INTO tblWebUser VALUES (2,'customer','customer',0,'','','web','user','webland','universe','Saarland','','','','','','','0','0','0',0,'/customer',0,'customer.gif','customer','','','Kunden');
