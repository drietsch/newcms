...
include_once($_SERVER['DOCUMENT_ROOT'] . '/webEdition/apps/leer/we_leerDirSelector.class.php');
include_once($_SERVER['DOCUMENT_ROOT'] . '/webEdition/apps/leer/language/language_' . $GLOBALS['WE_LANGUAGE'] . '.inc.php');

$_SERVER['PHP_SELF'] = '/webEdition/apps/leer/we_leerDirSelect.php';
$fs = new we_leerDirSelector(isset($id) ? $id : (isset($_REQUEST['id']) ? $_REQUEST['id'] : (isset($_REQUEST['we_cmd'][1]) ? $_REQUEST['we_cmd'][1] : '')),
