...
include_once($_SERVER['DOCUMENT_ROOT'] . '/webEdition/apps/abc/class/we_abcDirSelector.class.php');
include_once($_SERVER['DOCUMENT_ROOT'] . '/webEdition/apps/abc/language/language_' . $GLOBALS['WE_LANGUAGE'] . '.inc.php');

$_SERVER['PHP_SELF'] = '/webEdition/apps/abc/we_abcDirSelect.php';
$fs = new we_abcDirSelector(isset($id) ? $id : (isset($_REQUEST['id']) ? $_REQUEST['id'] : (isset($_REQUEST['we_cmd'][1]) ? $_REQUEST['we_cmd'][1] : '')),
