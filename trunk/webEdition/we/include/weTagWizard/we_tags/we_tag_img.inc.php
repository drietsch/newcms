...
$GLOBALS['weTagWizard']['attribute']['id300_id'] = new weTagData_selectorAttribute('300', 'id',FILE_TABLE, 'image/*', false, '');
...
$GLOBALS['weTagWizard']['attribute']['id714_startid'] = new weTagData_selectorAttribute('714', 'startid',FILE_TABLE, 'folder', false, '');
$GLOBALS['weTagWizard']['attribute']['id715_parentid'] = new weTagData_selectorAttribute('715', 'parentid',FILE_TABLE, 'folder', false, '');
