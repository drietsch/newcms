...
$GLOBALS['weTagWizard']['attribute']['id609_classid'] = new weTagData_selectorAttribute('609', 'classid',OBJECT_TABLE, 'object', false, '');
...
$GLOBALS['weTagWizard']['attribute']['id616_triggerid'] = new weTagData_selectorAttribute('616', 'triggerid',FILE_TABLE, 'text/webedition', false, '');
$GLOBALS['weTagWizard']['attribute']['id617_workspaces'] = new weTagData_textAttribute('617', 'workspaces', false, '');
$GLOBALS['weTagWizard']['attribute']['id640_parentid'] = new weTagData_selectorAttribute('640', 'parentid',OBJECT_FILES_TABLE, 'folder', false, '');
