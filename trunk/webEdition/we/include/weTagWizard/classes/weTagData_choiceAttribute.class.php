...
class weTagData_choiceAttribute
extends weTagDataAttribute {
	...
	function getCodeForTagWizard() {
		...
		$select = new we_htmlSelect(array('onchange'=>$jsSelect, 'class' => 'defaultfont selectinput'));
		...
		return '
					...
					<tr>
						...
						<td class="attributeField">' . we_htmlElement::htmlInput(array('name'=>$this->Name, 'value'=>$this->Value, 'id'=>$this->getIdName(), 'class' => 'wetextinput')) . '</td>
