...
$this->_sections['classtrees']['loop'] = is_array($_loop=$this->_tpl_vars['trees']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['trees']['loop'] = is_array($_loop=$this->_tpl_vars['trees'][$this->_sections['classtrees']['index']]['trees']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
