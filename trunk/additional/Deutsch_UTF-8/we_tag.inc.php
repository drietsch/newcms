...
$l_we_tag['icon']['description'] = "Das we:icon-Tag erzeugt ein HTML-Tag, das auf ein webEdition internes Icon mit der unten angegebenen ID verweist. Dadurch k&ouml;nnen Sie ein Icon einbinden, welches beim bookmarken Ihrer Homepage im Internet Explorer, Mozilla, Safari und Opera angezeigt wird.";
...
$l_we_tag['useShopVariant']['description'] = "Das we:shopVariant-Tag ?bernimmt die Daten einer per Namen ?bergebenen Artikel-Variante. Existiert kein Artikel-Variante mit gegebenem Namen, wird der Original-Artikel verwendet.";
