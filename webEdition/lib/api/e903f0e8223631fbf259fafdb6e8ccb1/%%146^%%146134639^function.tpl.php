...
$this->_sections['params']['last']       = ($this->_sections['params']['iteration'] == $this->_sections['params']['total']);
 if ($this->_sections['params']['index'] > 0): ?>, <?php endif;  if ($this->_tpl_vars['intricatefunctioncall']['params'][$this->_sections['params']['index']]['hasdefault']): ?>[<?php endif;  echo $this->_tpl_vars['intricatefunctioncall']['params'][$this->_sections['params']['index']]['name'];  if ($this->_tpl_vars['intricatefunctioncall']['params'][$this->_sections['params']['index']]['hasdefault']): ?> = <?php echo $this->_tpl_vars['intricatefunctioncall']['params'][$this->_sections['params']['index']]['default']; ?>
