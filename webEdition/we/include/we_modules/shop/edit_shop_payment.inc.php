...
if(!empty($_REQUEST["fieldForname"])){	//	save data in arrays .. 
	...
	$DB_WE->query($q);
	if ( $DB_WE->num_rows() > 0) {
		$DB_WE->query("UPDATE ".ANZEIGE_PREFS_TABLE." SET strFelder= '" . $_REQUEST["fieldForname"]. "|" . $_REQUEST["fieldSurname"]. "|" . $_REQUEST["fieldStreet"]. "|" . $_REQUEST["fieldZip"]. "|" . $_REQUEST["fieldCity"]. "|". $_REQUEST["lc"]. "|" . $_REQUEST["ppB"]. "|" . $_REQUEST["psb"]. "|" . $_REQUEST["lcS"]. "|" . $_REQUEST["spAID"]. "|" . $_REQUEST["spB"]. "|" . $_REQUEST["spC"]. "|" . $_REQUEST["spD"]. "|" . $_REQUEST["spCo"]. "|" . $_REQUEST["spPS"]. "|" . $_REQUEST["spcmdP"]. "|" . $_REQUEST["spconfP"]. "|" . $_REQUEST["spdesc"].  "|" . $_REQUEST["fieldEmail"] . "' where strDateiname = 'payment_details'");
	} else {
