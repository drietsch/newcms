...
$l_object["no_root_ws_select"] = "Le r�pertoire source ne peut pas �tre choisi comm �space de travail!";
...
$l_object["objectFile_response_save_ok"] = "L'object '%s' a �t� enregistr� avec succ�s!";
$l_object["objectFile_response_publish_ok"] = "L'object '%s' a �t� publi� avec succ�s!";
$l_object["objectFile_response_unpublish_ok"] = "L'object '%s' a �t� depubli� avec succ�s!";
...
$l_object["fieldNameNotTitleDesc"] = "Les nom de champs \"Titre\" et \"D�scpription ne sont pas licites\"!";
$l_object["fieldNameEmpty"] = "Le nom de champs ne doit pas �tre vide!";
$l_object["length"] = "Longeur";
$l_object["type"] = "Type"; // TRANSLATE
$l_object["default"] = "Pr�reglage";
...
$l_object["behaviour_all"] = "Un object est tousjours visible, si aucun �space de travail n'a �t� choisi!";
$l_object["behaviour_no"] = "Un object n'est pas visible, si aucun �space de travail n'a �t� choisi!";

$l_object["generated_template_for_objectFile"] = "Aucun mod�le correspondant.";

$l_object["no_workspace_defined"] = "Aucun �space de travail n'a �t� encore assign� � cet object. Si vous voulez assigner � un object des �paces de travail specieaux, vous devez les choisir dans la classe de l'object.";
