...
$l_backup["charset_warning"] = "Sollte es Probleme beim Wiederherstellen eines Backups geben, achten Sie bitte darauf, dass im Zielsystem der selbe Zeichensatz (Charset) wie im Quellsystem verwendt wird. Dies gilt sowohl für den Zeichensatz der Datenbank (collation), als auch für den Zeichensatz der verwendeten Oberflächensprache!";
