...
$_SERVER["HTTP_USER_AGENT"] = (isset($_REQUEST["WE_HTTP_USER_AGENT"]) && $_REQUEST["WE_HTTP_USER_AGENT"]) ?  $_REQUEST["WE_HTTP_USER_AGENT"] : (isset($_SERVER["HTTP_USER_AGENT"]) ? $_SERVER["HTTP_USER_AGENT"] : "");
...
if(eregi("safari",$_SERVER["HTTP_USER_AGENT"])){
	...
	$BROWSER = "IE";
}else if(eregi("mozilla",$_SERVER["HTTP_USER_AGENT"])){
	$BROWSER = "NN";
