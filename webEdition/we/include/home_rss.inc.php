...
htmlTop();
print STYLESHEET;
print '<style type="text/css">div#rss,div#rss *{color:black;font-size:'.(($SYSTEM=="MAC")?"10px":(($SYSTEM=="X11")?"12px":"11px")).';font-family:'.$l_css["font_family"].';}</style>';
...
foreach ($rss->getItems() as $item) {
	...
	if(isset($item['link']) && !empty($item['link'])) $rss_out .= "<a href=\"".$item['link']."\" target=\"_blank\">".$l_cockpit['more']."</a>";
	$rss_out .= "</p>\n";
