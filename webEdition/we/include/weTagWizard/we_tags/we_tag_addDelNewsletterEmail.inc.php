...
$GLOBALS['weTagWizard']['attribute']['id20_mailid'] = new weTagData_selectorAttribute('20', 'mailid',FILE_TABLE, 'text/webedition', false, '');
...
$GLOBALS['weTagWizard']['attribute']['id23_id'] = new weTagData_selectorAttribute('23', 'id',FILE_TABLE, 'text/webedition', false, '');
