...
$GLOBALS['weTagWizard']['attribute']['id105_classid'] = new weTagData_selectorAttribute('105', 'classid',OBJECT_TABLE, 'object', false, '');
$GLOBALS['weTagWizard']['attribute']['id106_pid'] = new weTagData_selectorAttribute('106', 'pid',FILE_TABLE, 'folder', false, '');
$GLOBALS['weTagWizard']['attribute']['id652_pid'] = new weTagData_selectorAttribute('652', 'pid',OBJECT_FILES_TABLE, 'folder', false, '');
